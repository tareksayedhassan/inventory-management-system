...
-- AddForeignKey
ALTER TABLE `Notification` ADD CONSTRAINT `Notification_treasuryId_fkey` FOREIGN KEY (`treasuryId`) REFERENCES `Treasury`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
