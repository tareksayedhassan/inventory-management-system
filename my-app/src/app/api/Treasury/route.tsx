...
export async function POST(req: NextRequest) {
  try {
    ...
    const is_master = formData.get("is_master") === "false";
    ...
    const newTreasury = await prisma.treasury.create({
      data: {
        name,
        is_master,
        last_exchange_receipt_number: last_exchange_receipt_number,
        last_collect_receipt_number: last_collect_receipt_number,
        added_by_id,
        updated_by_id,
      },
    });
